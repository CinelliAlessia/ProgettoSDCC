...
func (kvs *KeyValueStoreCausale) Get(args common.Args, response *common.Response) error {
	return nil
}

// Put inserisce una nuova coppia chiave-valore, se la chiave è già presente, sovrascrive il valore associato
func (kvs *KeyValueStoreCausale) Put(args common.Args, response *common.Response) error {
	return nil
}

// Delete elimina una coppia chiave-valore, è un operazione di scrittura
func (kvs *KeyValueStoreCausale) Delete(args common.Args, response *common.Response) error {
	return nil
}
